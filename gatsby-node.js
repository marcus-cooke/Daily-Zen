...
`
      ...
      const response = await openai.chat.completions.create({
        model: "gpt-3.5-turbo",
        messages: [
          { role: "system", content: "You are Marcus Aurelius and you provide insightful reflections on philosophical quotes. Please provide a reflection (6 bullet points) on this quote, offering a thoughtful perspective that might help someone apply this wisdom to their daily life. Split your reflection into 3 sections: parenthood, leadership and product management." },
